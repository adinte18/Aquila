...
RenderingSystem::PrefilterRenderingSystem::PrefilterRenderingSystem(Engine::Device &device, VkRenderPass renderPass,
...
void RenderingSystem::PrefilterRenderingSystem::Render(VkCommandBuffer commandBuffer, VkDescriptorSet descriptorSet, glm::mat4& viewMatrix, uint32_t mipLevel) {
...
void RenderingSystem::PrefilterRenderingSystem::CreatePipeline(VkRenderPass renderPass) {
...
void RenderingSystem::PrefilterRenderingSystem::RecreatePipeline(VkRenderPass renderPass) {
    if (pipeline) {
        pipeline.reset();
    }
...
void RenderingSystem::PrefilterRenderingSystem::CreatePipelineLayout(VkDescriptorSetLayout layout) {
