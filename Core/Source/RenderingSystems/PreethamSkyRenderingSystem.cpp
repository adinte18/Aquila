...
namespace Engine {
    ...
    PreethamSkyRenderingSystem::PreethamSkyRenderingSystem(Engine::Device &device, VkRenderPass renderPass,
    ...
    void PreethamSkyRenderingSystem::Render(VkCommandBuffer commandBuffer, VkDescriptorSet descriptorSet, glm::mat4& viewMatrix) {
    ...
    void PreethamSkyRenderingSystem::CreatePipeline(VkRenderPass renderPass) {
    ...
    void PreethamSkyRenderingSystem::RecreatePipeline(VkRenderPass renderPass) {
        if (pipeline) {
            pipeline.reset();
        }
    ...
    void PreethamSkyRenderingSystem::CreatePipelineLayout(VkDescriptorSetLayout layout) {
