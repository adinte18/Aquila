...
Engine::Renderer::Renderer(Window& window, Device& device)
...
VkImageView Engine::Renderer::vk_GetCurrentImageView() const {
    return swapChain->getImageView(currentImageID);
}

VkCommandBuffer Engine::Renderer::vk_BeginFrame()
{
...
void Engine::Renderer::vk_EndFrame()
{
...
VkExtent2D Engine::Renderer::vk_GetSwapChainExtent() const
{
    return swapChain->getSwapChainExtent();
}

void Engine::Renderer::vk_BeginSwapChainRenderPass(VkCommandBuffer commandBuffer)
{
    assert(frameStarted
...
void Engine::Renderer::vk_EndSwapChainRenderPass(VkCommandBuffer commandBuffer)
{
    assert(frameStarted
...
void Engine::Renderer::vk_CreateCommandBuffers(){
...
void Engine::Renderer::vk_FreeCommandBuffers()
{
...
void Engine::Renderer::vk_RecreateSwapChain() {
