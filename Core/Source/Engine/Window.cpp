...
Engine::Window::Window(const int width, const int height,
  ...
  m_Window =
      glfwCreateWindow(mode->width, mode->height, "Aquila", nullptr, nullptr);
...
void Engine::Window::CreateWindowSurface(VkInstance instance,
...
void Engine::Window::FramebufferResizedCallback(GLFWwindow *window, int width,
                                                int height) {
