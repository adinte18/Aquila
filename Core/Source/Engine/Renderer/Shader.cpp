...
//
// std::vector<std::uint32_t> Shader::CompileShaderGlslang(EShLanguage
// shaderType, const std::string& filename) {
...
//                       EShMsgDefault))
//     {
//         std::cerr << "Shader preprocessing failed: " << shader.getInfoLog()
//         << std::endl; glslang::FinalizeProcess(); throw
//         std::runtime_error("Shader preprocessing failed.");
//     }
//
