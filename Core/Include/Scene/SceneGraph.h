...
//     static void Traverse(entt::registry& registry, entt::entity entity, int
//     depth); static void AddChild(entt::registry& registry, entt::entity
//     parent, entt::entity child);

//     static void RemoveChild(entt::registry& registry, entt::entity parent,
//     entt::entity child); static void RemoveAllChildren(entt::registry&
//     registry, entt::entity parent);
// };
